""" 
For computing real and redshift space two-point correlation functions with halotools. 
"""
...
def compute_tpcf_s_mu(
    ...
    tpcf_s_mu = s_mu_tpcf(
        ...
        mu,
        period=boxsize,
        estimator="Natural", #u"Landy-Szalay", #NOTE: issue here with original method? Why?
        num_threads=num_threads,
        sample2=s_pos_cross,
        do_auto=do_auto,
    )
