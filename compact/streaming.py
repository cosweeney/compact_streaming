""" 
Functions for computing the streaming model integral, 
taken from https://github.com/florpi/GaussianStreamingModel. #TODO: just install the library. 
"""
...
def integrand_s_mu(
    ...
    def integrand(y):
        ...
        los_pdf = np.nan_to_num(los_pdf_function(vlos, s_perp, np.abs(y)), #np.abs(y)
                copy=False)
